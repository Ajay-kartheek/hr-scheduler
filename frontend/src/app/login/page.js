...
const ADMIN_EMAIL = 'admin@shellkode.com';
...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        if (typeof window !== 'undefined' && localStorage.getItem('sk_auth')) {
            router.replace('/');
            return;
        }
    ...
    const handleLogin = (e) => {
        ...
        setTimeout(() => {
            if (email === ADMIN_EMAIL && password === ADMIN_PASS) {
                setUserName('Admin');
                localStorage.setItem('sk_auth', JSON.stringify({ email, name: 'Admin', role: 'admin', ts: Date.now() }));
                    ...
                    <div className="welcome-content">
                        ...
                        <div className="typewriter-block">
                            <p className="typewriter-line typewriter-line-1">
                                Your HR command center is ready.
                            </p>
                            <p className="typewriter-line typewriter-line-2">
                                Let&apos;s manage your onboarding pipeline and keep things running smoothly.
                            </p>
                        </div>
                        {!showOnboardBtn ? (
                            ...
                            <button className="btn-onboard" onClick={handleStartDashboard}>
                                Go to Dashboard →
                            </button>
                        )}
                    </div>
                    ...
                    <form onSubmit={handleLogin}>
                        <div className="input-group">
                            ...
                            <div className="input-wrap">
                                <input type="email" id="email" placeholder="admin@shellkode.com" autoComplete="email"
