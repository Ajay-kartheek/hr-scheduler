        ...
        <aside className="sidebar">
            <div className="sidebar-brand">
                <div className="sidebar-brand-icon">
                    <svg viewBox="0 0 28 28" fill="none">
                        <rect width="28" height="28" rx="8" fill="url(#sk-grad)" />
                        <text x="14" y="18.5" textAnchor="middle" fill="#fff" fontFamily="Outfit, Inter, sans-serif" fontWeight="700" fontSize="12">SK</text>
                        <defs>
                            <linearGradient id="sk-grad" x1="0" y1="0" x2="28" y2="28">
                                <stop stopColor="#00275E" />
            ...
            <div className="sidebar-footer">
                <div className="sidebar-user">
                    <div className="sidebar-user-avatar">SK</div>
                    <div>
